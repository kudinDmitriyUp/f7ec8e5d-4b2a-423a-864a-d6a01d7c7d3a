...
export const metadata: Metadata = {
  title: "LuxeStay Hotel - Luxury Accommodations & World-Class Service",
  description: "Experience luxury hospitality at LuxeStay Hotel. Book premium rooms, enjoy fine dining, spa, and wellness facilities. Your perfect getaway awaits.",
  keywords: ["luxury hotel", "premium accommodations", "fine dining", "spa", "wellness retreat"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "LuxeStay Hotel - Your Luxury Getaway",
    description: "Discover luxury hospitality with world-class amenities and exceptional service",
    siteName: "LuxeStay Hotel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764379213239-aebmhyqz.jpg",
      alt: "Luxury hotel lobby"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "LuxeStay Hotel - Premium Luxury Accommodations",
    description: "Experience world-class hospitality and luxury amenities",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764379213239-aebmhyqz.jpg"]
  }
};
